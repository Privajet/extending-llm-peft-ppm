# %% TabPFN — Remaining Time (RT) prediction on BPIC20_DomesticDeclarations
...
run = wandb.init(
    project="baseline_tabpfn_RT_BPIC20_DomesticDeclarations",
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPIC20_DomesticDeclarations/plots/Baselines/TabPFN/RT"
