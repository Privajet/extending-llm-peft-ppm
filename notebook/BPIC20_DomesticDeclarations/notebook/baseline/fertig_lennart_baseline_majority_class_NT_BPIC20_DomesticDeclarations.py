# %% Majority (global-mean) baseline — Next-Time (NT) on BPIC20_DomesticDeclarations
...
run = wandb.init(
    project="baseline_majority_NT_BPIC20_DomesticDeclarations",
...
# %% Plots → disk (days)
plot_dir = "/ceph/lfertig/Thesis/notebook/BPIC20_DomesticDeclarations/plots/Baselines/MAJ/NT"
