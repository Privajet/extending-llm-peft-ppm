# %% N-gram baseline — Next-Time (NT) on BPIC20_DomesticDeclarations
...
run = wandb.init(
    project="baseline_ngram_NT_BPIC20_DomesticDeclarations",
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPIC20_DomesticDeclarations/plots/Baselines/NGRAM/NT"
