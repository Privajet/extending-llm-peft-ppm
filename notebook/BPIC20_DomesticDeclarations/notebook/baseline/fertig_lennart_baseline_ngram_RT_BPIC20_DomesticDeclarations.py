# %% N-gram baseline — Remaining-Time (RT) on BPIC20_DomesticDeclarations
...
run = wandb.init(
    project="baseline_ngram_RT_BPIC20_DomesticDeclarations",
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPIC20_DomesticDeclarations/plots/Baselines/NGRAM/RT"
