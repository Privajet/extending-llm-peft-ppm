# %% LSTM baseline — Remaining Time (RT) prediction on BPIC20_DomesticDeclarations
...
run = wandb.init(
    project="baseline_lstm_RT_BPIC20_DomesticDeclarations",
    entity="privajet-university-of-mannheim",
    name=f"lstm_rt_{ts}",
    config=config
)

CKPT_PATH = "/tmp/best_lstm_rt_BPIC20_DomesticDeclarations.weights.h5"
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPIC20_DomesticDeclarations/plots/Baselines/LSTM/RT"
