# %% ProcessTransformer — Remaining-Time (RT) prediction on BPIC20_DomesticDeclarations
...
run = wandb.init(
    project="baseline_processTransformer_RT_BPIC20_DomesticDeclarations",
...
ckpt_path = "/tmp/best_transformer_rt_BPIC20_DomesticDeclarations.weights.h5"
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPIC20_DomesticDeclarations/plots/Baselines/Transformer/RT"
