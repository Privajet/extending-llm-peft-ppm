...
run = wandb.init(
    project=f"baseline_processTransformer_RT_{config['dataset']}",
...
# %% Inference helper (return days, top-k)
...
artifact = wandb.Artifact(f"transformer_rt_model_{config['dataset']}", type="model")
