...
run = wandb.init(
    project="gpt-neo-1.3B_ACT_Zero-Shot_BPIC20_DomesticDeclarations",
...
# %%
# Plots → disk (headless)
plot_dir = "/ceph/lfertig/Thesis/notebook/BPIC20_DomesticDeclarations/plots/ICL/ACT_ZeroShot"
