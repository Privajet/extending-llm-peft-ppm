# %% Majority (global-mean) baseline — Remaining Time (RT) on HelpDesk
...
run = wandb.init(
    project="baseline_majority_RT_HelpDesk",
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/HelpDesk/plots/Baselines/MAJ/RT"
