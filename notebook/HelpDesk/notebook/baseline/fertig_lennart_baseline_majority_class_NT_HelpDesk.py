# %% Majority (global-mean) baseline — Next-Time (NT) on HelpDesk
...
run = wandb.init(
    project="baseline_majority_NT_HelpDesk",
...
# %% Plots → disk (days)
plot_dir = "/ceph/lfertig/Thesis/notebook/HelpDesk/plots/Baselines/MAJ/NT"
