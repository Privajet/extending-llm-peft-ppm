...
RUN_CFG = {
    ...
    "plots_dir": "/ceph/lfertig/Thesis/notebook/HelpDesk/plots/Qwen3-4B/ZS/NT",
    "unit": "days"
}
...
run = wandb.init(
    project="Qwen3-4B_NT_ZeroShot_HelpDesk",
    entity="privajet-university-of-mannheim",
    name=f"qwen3-4b_zeroshot_nt_{ts}",
...
def score_bins(prefix_tokens, last_act=None):
    ...
    input_ids = torch.nn.utils.rnn.pad_sequence(rows, batch_first=True, padding_value=pad_id).to(DEVICE)  # <-- move to DEVICE
