# %% Majority (global-mean) baseline — Remaining Time (RT) on P2P
...
run = wandb.init(
    project="baseline_majority_RT_P2P",
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/P2P/plots/Baselines/MAJ/RT"
