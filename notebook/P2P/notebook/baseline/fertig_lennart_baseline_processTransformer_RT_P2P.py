# %% ProcessTransformer — Remaining-Time (RT) prediction on P2P
...
run = wandb.init(
    project="baseline_processTransformer_RT_P2P",
...
ckpt_path = "/tmp/best_transformer_rt_P2P.weights.h5"
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/P2P/plots/Baselines/Transformer/RT"
