...
run = wandb.init(
    project="baseline_processTransformer_ACT_P2P",
...
# %%
ckpt_path = "/tmp/best_transformer_act_P2P.weights.h5"
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/P2P/plots/Baselines/Transformer/ACT"
