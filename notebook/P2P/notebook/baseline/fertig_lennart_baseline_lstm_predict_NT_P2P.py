# %% LSTM baseline — Next-Time (NT) prediction on P2P
...
run = wandb.init(
    project="baseline_lstm_NT_P2P",
    entity="privajet-university-of-mannheim",
    name=f"lstm_nt_{ts}",
    config=config
)

CKPT_PATH = "/tmp/best_lstm_nt_P2P.weights.h5"
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/P2P/plots/Baselines/LSTM/NT"
