# %% Zero-shot (ICL-free) Next-Activity prediction (ACT) with GPT-Neo-1.3B
...
run = wandb.init(
    project="gpt-neo-1.3B_ACT_Zero-Shot_BPI_Challenge_2012C",
...
MAX_LEN = 512  # match FT's max_seq_le
...
# %% Plots → disk (headless)
plot_dir = "/ceph/lfertig/Thesis/notebook/BPI_Challenge_2012C/plots/ZS/ACT"
