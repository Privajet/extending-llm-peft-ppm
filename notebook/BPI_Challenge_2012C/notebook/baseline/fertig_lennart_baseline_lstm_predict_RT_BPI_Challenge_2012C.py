# %% LSTM baseline — Remaining Time (RT) prediction on BPI_Challenge_2012C
...
run = wandb.init(
    project="baseline_lstm_RT_BPI_Challenge_2012C",
    entity="privajet-university-of-mannheim",
    name=f"lstm_rt_{ts}",
    config=config
)

CKPT_PATH = "/tmp/best_lstm_rt_BPI_Challenge_2012C.weights.h5"
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPI_Challenge_2012C/plots/Baselines/LSTM/RT"
