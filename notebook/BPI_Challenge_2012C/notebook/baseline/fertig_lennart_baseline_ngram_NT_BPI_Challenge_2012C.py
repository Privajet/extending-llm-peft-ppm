# %% N-gram baseline — Next-Time (NT) on BPI_Challenge_2012C
...
run = wandb.init(
    project="baseline_ngram_NT_BPI_Challenge_2012C",
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPI_Challenge_2012C/plots/Baselines/NGRAM/NT"
