# %% ProcessTransformer — Next-Time (NT) prediction on BPI_Challenge_2012C
...
run = wandb.init(
    project="baseline_processTransformer_NT_BPI_Challenge_2012C",
...
CKPT_PATH = "/tmp/best_transformer_nt_BPI_Challenge_2012C.weights.h5"
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPI_Challenge_2012C/plots/Baselines/Transformer/NT"
