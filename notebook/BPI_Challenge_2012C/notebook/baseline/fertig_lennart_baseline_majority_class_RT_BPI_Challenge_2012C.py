# %% Majority (global-mean) baseline — Remaining Time (RT) on BPI_Challenge_2012C
...
run = wandb.init(
    project="baseline_majority_RT_BPI_Challenge_2012C",
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPI_Challenge_2012C/plots/Baselines/MAJ/RT"
