...
run = wandb.init(
    project="baseline_processTransformer_ACT_BPI_Challenge_2012C",
...
# %% Data (same path/split scheme as LSTM)
...
# %%
ckpt_path = "/tmp/best_transformer_act_BPI_Challenge_2012C.weights.h5"
...
# %% Plots → disk
plot_dir = "/ceph/lfertig/Thesis/notebook/BPI_Challenge_2012C/plots/Baselines/Transformer/ACT"
