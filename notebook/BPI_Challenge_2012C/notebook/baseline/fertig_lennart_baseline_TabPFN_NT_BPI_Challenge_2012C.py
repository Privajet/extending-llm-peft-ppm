# %% TabPFN — Next-Time (NT) prediction on BPI_Challenge_2012C
...
run = wandb.init(
    project="baseline_tabpfn_NT_BPI_Challenge_2012C",
...
# %%  Plots
plot_dir = "/ceph/lfertig/Thesis/notebook/BPI_Challenge_2012C/plots/Baselines/TabPFN/NT"
